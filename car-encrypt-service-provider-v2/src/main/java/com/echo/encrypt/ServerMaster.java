...
public class ServerMaster {
    ...
    public void init() {
        ...
        hashMap.put("privateEncKey", CodeUtil.encodeToString(encryptPrivateKey.toByteArray()));
        hashMap.put("privateSignKey", CodeUtil.encodeToString(signPrivateKey.toByteArray()));
        hashMap.put("privateExecKey", CodeUtil.encodeToString(exchangePrivateKey.toByteArray()));
